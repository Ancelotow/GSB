...
class visiteur extends \GSB\VisiteurBundle\Entity\visiteur implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'user', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'id', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'nom', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'prenom', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'adresse', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'ville', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'cp', '' . "\0" . 'GSB\\VisiteurBundle\\Entity\\visiteur' . "\0" . 'dateEmbauche'];
        }
